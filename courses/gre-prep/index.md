...
[How It Works](/how-it-works). Every session ≈ 1 hour.
...
content the diagnostic shows is already known.
...
|:--|:--|:--|:--|
| [1](day-01) | Aug 4 | Quant: Divisibility, Factors, Primes (the real gap — 0/1, 3m23s) + arithmetic speed strategy | Not started |
| [2](day-02) | Aug 5 | Quant: Arithmetic Operations, Percents/Ratios reinforcement + backsolving & plugging in | Not started |
...
| [9](day-09) | Aug 12 | Quant: Geometry & Data Analysis maintenance + full mixed timed set | Not started |
...
| [14](day-14) | Aug 17 | Review day: fix whatever the logged data shows is weakest — no new topics | Not started |
...
| [17](day-17) | Aug 20 | Light review: vocab final pass, AWA template refresh, confidence practice | Not started |
...
**Vocab track runs throughout:** a small flashcard deck (~15-20 words) most
days, building toward exam day. Progress and specific word lists live on each
day's page, not duplicated here.
